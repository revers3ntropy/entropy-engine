    ...
    runFunc(func, context) {
        ...
        if (func.this_) {
            if (typeof func.this_ !== 'object')
                return new TypeError(this.startPos, this.endPos, 'object', typeof func.this_, func.this_, '\'this\' must be an object');
...
export class N_function extends Node {
    constructor(startPos, endPos, body, argNames, name = '<anon func>', this_ = undefined) {
        super(startPos, endPos);
...
export class N_any extends Node {
    constructor(value, startPos = Position.unknown, endPos = Position.unknown) {
        super(startPos, endPos, true);
        this.val = value;
    }
    interpret_(context) {
