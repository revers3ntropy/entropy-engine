...
export class Mat4 extends Matrix {
    ...
    transformV3(v) {
        return new v3(v.x * this.at(0, 0) + v.y * this.at(0, 1) + v.z * this.at(2, 0) + this.at(0, 3), v.x * this.at(1, 0) + v.y * this.at(1, 1) + v.z * this.at(1, 2) + this.at(1, 3), v.x * this.at(2, 0) + v.y * this.at(2, 1) + v.z * this.at(2, 2) + this.at(2, 3));
    }
    static unit() {
        const m = new Mat4(0);
        for (let i = 0; i < 4; i++) {
